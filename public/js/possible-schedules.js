...
function createHTML() {
    ...
    $.each(schedules, function (index, schedule) {
        ...
        html += '<button class="btn btn-lg" style="; border-radius: 2px;"><i class="fas fa-expand-arrows-alt"></i></button>';
        html += '<button style="z-index: 100; ;border-radius: 2px; " id="star' + index + '"  class="btn btn-lg possStar"	onclick="event.stopPropagation();starSchedule(this);  "><i class="fas fa-star"></i></button>';
        html += '</div></div>\n';
    });
